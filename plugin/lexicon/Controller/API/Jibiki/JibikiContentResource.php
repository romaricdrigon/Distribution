...
class JibikiContentResource
{
    ...
    protected function __construct($name, $category, $type, $authors)
    {
        $this->name = $name;
    ...
    function get_articles($dictname, $src, $key, $value, $strategy)
    {
        $article = '';
    ...
    function put_article($dictname, $src, $articleid, $articledata, $user, $password)
    {
        $article = '';
    ...
    function put_article_part($dictname, $src, $contributionid, $xpath, $value, $user, $password)
    {
        $article = '';
    ...
    function delete_article($dictname, $src, $articleid, $user, $password)
    {
