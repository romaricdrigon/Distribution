...
use Claroline\LexiconBundle\Controller\API\Jibiki\JBKUsers;
use Claroline\LexiconBundle\Controller\API\Jibiki\JBKResources;
...
class LexiconListener
{
    ...
    private function desktop()
    {
      ...
      //$data_content = '{}';
      //$Users = new JBKUsers();
      //$resources = new JBKResources();
      //$dico = $resources->get_all_dictionaries();
      //print $dico;
